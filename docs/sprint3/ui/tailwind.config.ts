...
// DataNest Tailwind Config — Sprint 3
// 说明：继承 Sprint 2 全部 token，新增 DAG 节点状态色与画布尺寸。
    ...
    theme: {
        extend: {
            colors: {
                ...
                // DAG node status
                'ds-node-waiting': '#94a3b8',
                'ds-node-running': '#4f46e5',
                'ds-node-success': '#16a34a',
                'ds-node-failed': '#dc2626',
                'ds-node-skipped': '#d97706',
            },
