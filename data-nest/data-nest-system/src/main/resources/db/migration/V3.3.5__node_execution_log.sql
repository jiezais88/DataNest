...
COMMENT ON TABLE node_execution_log IS 'DAG 节点执行日志';
COMMENT ON COLUMN node_execution_log.level IS '日志级别：INFO / WARN / ERROR';
COMMENT ON COLUMN node_execution_log.line_num IS '行号，用于排序';
