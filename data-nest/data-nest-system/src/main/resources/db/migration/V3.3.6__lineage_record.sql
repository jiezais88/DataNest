...
COMMENT
ON COLUMN lineage_record.source_table IS '源表名';
COMMENT
ON COLUMN lineage_record.target_table IS '目标表名';
COMMENT
ON COLUMN lineage_record.lineage_type IS '血缘类型：SQL / SYNC / PYTHON';
