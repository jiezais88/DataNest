...
ALTER
COLUMN applicable_standards TYPE TEXT USING applicable_standards::TEXT;

COMMENT
ON COLUMN compliance_check_result.applicable_standards IS '本次检查涉及的相关规范列表（JSON），用于结果展示';
