...
@SaCheckPermission(PermissionCode.QUALITY_JOB_VIEW)
public class QualityJobController {
    ...
    @PostMapping
    @SaCheckPermission(PermissionCode.QUALITY_JOB_CREATE)
    ...
    @PutMapping("/{id}")
    @SaCheckPermission(PermissionCode.QUALITY_JOB_UPDATE)
    ...
    @DeleteMapping("/{id}")
    @SaCheckPermission(PermissionCode.QUALITY_JOB_DELETE)
