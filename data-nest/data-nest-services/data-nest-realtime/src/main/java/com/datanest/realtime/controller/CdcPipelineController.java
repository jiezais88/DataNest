...
public class CdcPipelineController {
    ...
    @SaCheckPermission(PermissionCode.CDC_CREATE)
    ...
    @PutMapping("/{id}")
    @SaCheckPermission(PermissionCode.CDC_UPDATE)
    ...
    @DeleteMapping("/{id}")
    @SaCheckPermission(PermissionCode.CDC_DELETE)
    ...
    @SaCheckPermission(PermissionCode.CDC_EXECUTE)
