...
public class TaskTemplateController {
    ...
    @SaCheckPermission(PermissionCode.TEMPLATE_VIEW)
    @GetMapping
    ...
    @SaCheckPermission(PermissionCode.TEMPLATE_CREATE)
    @PostMapping
    ...
    @SaCheckPermission(PermissionCode.TEMPLATE_UPDATE)
    @PutMapping("/{id}")
    ...
    @SaCheckPermission(PermissionCode.TEMPLATE_DELETE)
    @DeleteMapping("/{id}")
