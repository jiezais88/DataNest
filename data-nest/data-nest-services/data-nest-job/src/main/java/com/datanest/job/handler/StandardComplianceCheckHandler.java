 ...
 */
@Component
public class StandardComplianceCheckHandler implements PlatformJobHandler {
    ...
    public String getName() {
        return "standardComplianceCheckHandler";
    }
    ...
    public void execute(String param) {
        ...
        if (count == null) {
            throw new IllegalStateException("标准合规扫描失败: governance 服务不可用，本轮跳过");
        }
