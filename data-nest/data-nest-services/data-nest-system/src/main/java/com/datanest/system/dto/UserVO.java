...
public record UserVO(
        ...
        @Schema(description = "认证来源（LOCAL/OIDC/LDAP）") String authSource,
        @Schema(description = "IdP 唯一标识（OIDC sub / LDAP dn）") String ssoSubject,
        @Schema(description = "登录锁定截止时间") LocalDateTime lockedUntil,
