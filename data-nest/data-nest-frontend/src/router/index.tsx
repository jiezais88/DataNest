...
const QualityReportPage = lazyPage(() => import('@/pages/governance/quality-report'));
...
const ClassificationPage = lazyPage(() => import('@/pages/data-service/classification'));
...
export const router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'governance/quality-report', element: <QualityReportPage/>},
            ...
            {path: 'data-service/classification', element: <ClassificationPage/>},
        ],
    },
]);
