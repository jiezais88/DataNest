        ...
        <div className="bg-white border border-ds-border-subtle rounded-ds-md overflow-hidden">
            <table className="w-full">
                ...
                <tr className="border-b border-ds-border-subtle bg-ds-bg-hover/80">
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">库名</th>
                </tr>
                </thead>
                <tbody>
                {databases.map((db) => (
    ...
    const renderSchemaList = () => (
        <div className="bg-white border border-ds-border-subtle rounded-ds-md overflow-hidden">
            <table className="w-full">
                <thead>
                <tr className="border-b border-ds-border-subtle bg-ds-bg-hover/80">
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">Schema</th>
                </tr>
                </thead>
                <tbody>
                {schemas.map((schema) => (
    ...
    const renderTableList = () => (
        <div className="bg-white border border-ds-border-subtle rounded-ds-md overflow-hidden">
            <table className="w-full">
                <thead>
                <tr className="border-b border-ds-border-subtle bg-ds-bg-hover/80">
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">表名</th>
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">注释</th>
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">字段数</th>
                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">采集来源</th>
                </tr>
                </thead>
                <tbody>
                {tables.map((table) => (
                    ...
                    {columnsLoading ? (
                        ...
                        <div className="bg-white border border-ds-border-subtle rounded-ds-md overflow-hidden">
                            <table className="w-full">
                                <thead>
                                <tr className="border-b border-ds-border-subtle bg-ds-bg-hover/80">
                                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">字段名</th>
                                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">数据类型</th>
                                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">中文注释</th>
                                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">是否可空</th>
                                    <th className="text-left px-ds-4 py-ds-3 text-ds-caption text-ds-text-muted font-semibold">备注</th>
                                </tr>
                                </thead>
                                <tbody>
                                {columns.map((column) => (
