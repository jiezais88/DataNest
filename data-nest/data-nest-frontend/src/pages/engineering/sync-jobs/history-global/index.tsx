...
import type {SyncHistoryStatus, SyncJobHistory, SyncJobHistoryQueryParams, SyncJobLog,} from '../../../../types/sync';
...
export default function SyncJobHistoryGlobalPage() {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            const result = await queryAllSyncJobHistory(params);
            if (result.code === 200) {
                ...
                <div className="ds-table-card">
                    <div className="ds-table-scroll">
                        ...
                        {items.length === 0 && !loading && (
                            <EmptyState
                                title="暂无执行历史"
                                description="还没有同步任务执行记录，手动触发或等待 Cron 调度后自动产生。"
                            />
                        )}
                    </div>
